package com.example.laptoprecommender.config;
...
/**
 * Seeds the MongoDB database with laptop data on first run.
 * If the database already contains laptops, seeding is skipped.
 */
@Component
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        System.out.println("[DataSeeder] Seeding Indian market laptop database...");
        List<Laptop> laptops = buildDatabase();
        assignBenchmarks(laptops);
        laptopRepository.saveAll(laptops);
        System.out.println("[DataSeeder] Seeded " + laptops.size() + " laptops into MongoDB. Price range: ₹25K – ₹10L.");
    }
    ...
    private void add(List<Laptop> L, int id, String title, String desc,
        ...
        Laptop l = new Laptop();
        l.setLaptopId(id); l.setTitle(title); l.setDescription(desc);
